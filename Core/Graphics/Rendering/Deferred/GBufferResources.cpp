...
{
    return m_albedoOcclusion.IsCreated()
        && m_normal.IsCreated()
...
ColorRenderTarget2D &GBufferResources::GetEmissiveTarget() noexcept
{
    return m_emissive;
}

const ColorRenderTarget2D &GBufferResources::GetEmissiveTarget() const noexcept
{
    return m_emissive;
}
